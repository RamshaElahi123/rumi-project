...
const products = [
  ...
  { id: 11, name: "J. Pen Perfume Set", price: 1299, originalPrice: 1500, images: ["/images/PEN.jpeg"], category: "Scents", description: "Set of fine fragrances with unique notes." },
