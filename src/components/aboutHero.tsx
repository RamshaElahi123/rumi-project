...
const AboutHero = () => {
  return (
    <>
      {/* ✅ Emerald Navbar at top */}
      <Navbar />

      {/* ✅ Hero Section */}
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-white mt-16 md:mt-32 px-4">
        {/* Left Text Panel */}
        <div className="w-full md:w-[650px] h-auto md:h-[478px] bg-emerald-700 p-6 flex flex-col justify-start items-start text-left text-white">
